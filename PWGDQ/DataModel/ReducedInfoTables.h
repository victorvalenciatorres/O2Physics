...
DECLARE_SOA_COLUMN(Q3X0B, q3x0b, float);   //!  Q-vector x component, with event eta gap A (harmonic 3 and power 0)
DECLARE_SOA_COLUMN(Q3Y0B, q3y0b, float);   //!  Q-vector y component, with event eta gap A (harmonic 3 and power 0)
DECLARE_SOA_COLUMN(Q3X0C, q3x0c, float);   //!  Q-vector x component, with event eta gap A (harmonic 3 and power 0)
DECLARE_SOA_COLUMN(Q3Y0C, q3y0c, float);   //!  Q-vector y component, with event eta gap A (harmonic 3 and power 0)
...
DECLARE_SOA_TABLE(ReducedEventsQvector, "AOD", "REQVECTOR", //!    Event Q-vector information
                  reducedevent::Q1X0A, reducedevent::Q1Y0A, reducedevent::Q1X0B, reducedevent::Q1Y0B,
                  reducedevent::Q1X0C, reducedevent::Q1Y0C, reducedevent::Q2X0A, reducedevent::Q2Y0A, reducedevent::Q2X0B, reducedevent::Q2Y0B,
                  ...
                  reducedevent::Q3X0C, reducedevent::Q3Y0C, reducedevent::Q4X0A, reducedevent::Q4Y0A, reducedevent::Q4X0B, reducedevent::Q4Y0B,
                  reducedevent::Q4X0C, reducedevent::Q4Y0C);
